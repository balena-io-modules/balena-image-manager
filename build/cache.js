 ...
 */
var Promise, balena, fs, mime, mkdirp, path, rimraf, utils;
...
exports.isImageFresh = function(deviceType, version) {
  return exports.getImagePath(deviceType, version).then(function(imagePath) {
    ...
    return balena.models.os.getLastModified(deviceType, version).then(function(lastModifiedDate) {
...
exports.clean = function() {
  return balena.settings.get('cacheDirectory').then(rimraf);
};
